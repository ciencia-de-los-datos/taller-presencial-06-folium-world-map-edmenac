...
def clean_countries(affiliations):
    """Elimina los valores nulos y los valores que no son paises en la columna 'countries'"""

    affiliations = affiliations.copy()
    affiliations = affiliations.dropna(subset=["countries"])
    affiliations = affiliations[affiliations["countries"].str.len() > 0]
...
def count_country_frequency(affiliations):
    """Cuenta la frecuencia de cada pais en la columna 'countries'"""
